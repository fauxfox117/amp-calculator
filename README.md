...
- The app currently outputs **how many amps are needed** on a run. (Optional logic for telling dealers exactly *where* to splice is commented out and can be enabled if needed.)  
